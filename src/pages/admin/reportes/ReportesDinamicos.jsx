...
import { useReportesFilterConfig } from './config/reportesFilterConfig';
...
const Reportes = () => {
  ...
  return (
    <div>
      {/* Panel de título */}
      <AtomsPanel title="Reportes Dinámicos" subtitle="Información de las estadísticas y reportes del sistema" />
