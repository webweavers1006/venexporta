...
const ReportesDinamicosEventosActividad = () => {
  ...
  const handleExportExcel = async () => {
    await exportEmpresasToExcel(reporteData, 'LISTADO DE EMPRESAS POR SUB - SECTOR PRODUCTIVO');
  };

  // Exportar a PDF
  const handleExportPDF = () => {
     exportEmpresasToPDF(reporteData, null, null, 'LISTADO DE EMPRESAS POR SUB - SECTOR PRODUCTIVO');
  };
